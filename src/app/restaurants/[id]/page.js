      ...
      <DashboardLayout>
        <div className="flex flex-col items-center justify-center min-h-[50vh]">
          <div className="bg-amber-50 text-amber-800 p-6 rounded-lg border border-amber-200 max-w-md text-center">
            ...
            <p className="mb-4">
              Vous n'avez pas les permissions requises pour voir les détails des
              restaurants.
            </p>
            <Button
              variant="outline"
                ...
                <CardContent className="space-y-6">
                  <div className="flex flex-col items-center text-center">
                    ...
                    <p className="text-muted-foreground mt-1">
                      {/* Afficher le code uniquement pour les administrateurs */}
                      {isAdmin && `Code: ${restaurant.code}`}
                    </p>
                  </div>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid grid-cols-1 gap-4">
                        {/* N'afficher le code du restaurant que pour les administrateurs */}
                        {isAdmin && (
