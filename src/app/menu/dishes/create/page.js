...
function CreateDishContent() {
  ...
  const loadCategories = useCallback(
    async (tenantCode, page = 0, search = "") => {
  ...
  }, [effectiveTenantCode, categoryPage, categorySearch, loadCategories]);
    ...
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
        ...
        <Card>
            ...
            {fields.length === 0 ? (
              <div className="text-center py-8 border-2 border-dashed rounded-lg">
                ...
                <p className="text-muted-foreground mb-4">
                  Cliquez sur "Ajouter un ingrédient" pour composer votre plat
                </p>
                <Button type="button" onClick={handleAddProduct}>
                  <Plus className="h-4 w-4 mr-1" /> Ajouter un ingrédient
                </Button>
          ...
          {fields.length > 0 && (
            <CardFooter className="flex justify-end pt-0">
              <Button type="button" onClick={handleAddProduct}>
                <Plus className="h-4 w-4 mr-1" /> Ajouter un autre ingrédient
              </Button>
            </CardFooter>
          )}
        </Card>
        ...
        <div className="flex justify-end space-x-4 pt-4">
          ...
          <Button
            type="submit"
            disabled={loading.submitting || !isDirty || !effectiveTenantCode}
          >
            {loading.submitting ? (
              <>
...
export default function CreateDishPage() {
  return (
    <DashboardLayout>
      <Suspense fallback={<CreateDishLoading />}>
        <CreateDishContent />
      </Suspense>
    </DashboardLayout>
  );
